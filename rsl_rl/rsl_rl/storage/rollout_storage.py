...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, privileged_obs_shape, actions_shape, device="cpu"):
        ...
        self.ac_id = torch.zeros(num_envs, device=self.device, dtype=torch.long)
    ...
    def compute_returns(self, last_values, gamma, lam, ac_id=None):
        advantage = 0
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        ac_id = self.ac_id.repeat(self.num_transitions_per_env)
    ...
    def reccurent_mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                ac_id_batch = self.ac_id[start:stop]
